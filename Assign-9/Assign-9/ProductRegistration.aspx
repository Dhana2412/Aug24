<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegistration.aspx.cs" Inherits="Assign_9.ProductRegistration" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2"><div class="col-md-4"><asp:Image runat="server" ID="Image3" ImageUrl="https://th.bing.com/th/id/OIP.EN6R9tEWgyjOqXOSTKR5igHaO0?pid=ImgDet&rs=1"
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TxtPrice" ErrorMessage="Price must be in numeric values" ForeColor="Red" Type="Double"></asp:RangeValidator>
                    </td>
                </tr>
                <tr>
